...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Null, opts ...grpc.CallOption) (OrderService_ListOrdersClient, error) {
	stream, err := c.cc.NewStream(ctx, &OrderService_ServiceDesc.Streams[0], "/pb.OrderService/ListOrders", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *orderServiceListOrdersClient) Recv() (*CreateOrderResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrders(*Null, OrderService_ListOrdersServer) error
...
func (UnimplementedOrderServiceServer) ListOrders(*Null, OrderService_ListOrdersServer) error {
...
func (x *orderServiceListOrdersServer) Send(m *CreateOrderResponse) error {
